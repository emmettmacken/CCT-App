...
const ClinicianSettings: React.FC = () => {
  const [profile, setProfile] = useState<ClinicianProfile>({
    name: "",
  });
  const [tempProfile, setTempProfile] = useState<ClinicianProfile>({
    ...profile,
  });
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (data) {
        const profileData: ClinicianProfile = {
          name: data.name || "",
        };
